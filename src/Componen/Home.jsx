...
class Home extends React.Component {
  ...
  // Buttonclick = ()=>{
  //   this.state.Navigate('/f')
  // }

  render(){
    return(
      <body className=" px-4 lg:px-[200px]">
        {/* link */}
          ...
          <section className=" fixed bg-clear-/white pt-2 pb-4 bottom-0 lg:float-left lg:top-0 lg:left-0 lg:w-[72px] lg:bg-green lg:flex lg:justify-between lg:py-8 lg:items-center lg:flex-col lg:h-full " x-data="{open : false}" x-show="navOpen">
            ...
            <ul className="flex justify-center px-5 mx-auto gap-8 lg:items-center lg:gap-12 lg:flex-col lg:content-center">
                ...
                <li className="link flex justify-center flex-col items-center gap-0.5 -mt-14 -ml-2 lg:mt-0">
                  <button className="p-2.5 bg-yellow rounded-xl flex items-center">
        ...
        <div className="flex flex-col">
          {/* qty */}
          <section className="container mx-auto lg:h-[181px] mt-8 lg:order-1">
          ...
          <section className=" mt-10 container mx-auto lg:max-h-[1000px] lg:overflow-auto">
            <div className="mb-6">
              <h1 className="text-black text-2xl font-bold mb-4">Today</h1>
                    ...
                    <li key={index} className="">
                      <div className="bg-white rounded-[18px] flex py-2.5 px-6 items-center">
                        <div className="bg-op/[47] p-3 rounded-[18px] flex items-center mr-2">
                          <i class='bx bx-football text-green'></i>
                        </div>
                        ...
                        <button><img src={elips}></img></button>
                      </div>
                    </li>
                  )
                  })} 
            ...
            <div>
              <button onClick={this.Buttonclick} className="flex py-2.5 px-6 items-center justify-center gap-2 rounded-[18px] bg-yellow w-full">
